              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      navigateToAttendanceRecordPage(companyId, userDetails, attendanceRecords);
                    },
                    child: Card(
                      elevation: 6,
                      ...
                      child: ListTile(
                        ...
                        onLongPress: () {
                          // Add actions for long press
                        },
                        // Wrap the entire list tile with a Dismissible widget for swipe gestures
                        // Modify the background and behavior as per your requirements
                        // Example:
